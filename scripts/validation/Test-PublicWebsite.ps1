...
foreach ($requiredText in @(
    ...
    'class="store-symbol"',
    'OTP Harbor 2.0.0 is now publicly available from Microsoft Store, the primary Windows channel.',
    'OTP Harbor 2.0.0 is the stable GitHub release for Linux, Android and source archives.',
